...
class MarketAdmin(admin.ModelAdmin):
    ...
    list_filter = ['outdoor_navigation_enabled', 'indoor_map_enabled']
...
class ShopAdmin(admin.ModelAdmin):
    list_display = ['name', 'seller', 'market', 'latitude', 'longitude', 'is_verified']
...
class NavigationRouteAdmin(admin.ModelAdmin):
    list_display = ['start_shop', 'end_shop', 'distance_meters']
